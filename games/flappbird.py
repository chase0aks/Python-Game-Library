...
def Game():
	...
	pimg = [pygame.image.load("games/images/" + str(i) + '.png') for i in range(1, 5)]
	clock = pygame.time.Clock()
	vec = pygame.math.Vector2
	bg = pygame.image.load("games/images/bg.png")
	bw = bg.get_width()
	blist = [[50, 310], [60, 300], [70, 290], [80, 280], [90, 270], [100, 260],
	         [110, 250], [120, 240], [130, 230], [140, 220], [150,
	                                                          210], [160, 200],
	         [170, 190], [180, 180], [190, 170], [200, 160], [210,
	                                                          150], [220, 140],
	         [230, 130], [240, 120], [250, 110], [260, 100], [270, 90], [280, 80],
	...
	class TBlock(pygame.sprite.Sprite):
		...
		def __init__(self, x, h1):
			super().__init__()
			self.image = pygame.image.load("games/images/tp.png")
			self.image = pygame.transform.scale(self.image, (70, h1))
			self.rect = self.image.get_rect()
	...
	class BBlock(pygame.sprite.Sprite):
		...
		def __init__(self, x, h2):
			super().__init__()
			self.image = pygame.image.load("games/images/bp.png")
			self.image = pygame.transform.scale(self.image, (70, h2))
			self.rect = self.image.get_rect()
	...
	class Game:
		...
		def over(self):
			...
			while wait:
				for event in pygame.event.get():
					if event.type == pygame.QUIT:
						with open('games/fbscores.txt', 'a') as score:
		...
		def update(self):
			...
			hits1 = pygame.sprite.spritecollide(self.bird, self.bblocks, False,
			                                    pygame.sprite.collide_mask)
			hits2 = pygame.sprite.spritecollide(self.bird, self.tblocks, False,
			                                    pygame.sprite.collide_mask)
			if hits1 or hits2:
				self.over()
			relx = self.bgx % bw + 5
